...
/*
 * The vcpu parameter in the mmio handler functions can mean multiple things
 * depending on how the functions are called; when handling a trap from the
 * kernel it depends on the GIC version, and these functions are also called
 * as part of save/restore from userspace.
 *
